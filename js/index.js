...
var map = {
	...
	"./backgroundsupermove1.png": 195,
	"./backgroundsupermove2.png": 196,
	"./backgroundsupermove3.png": 197,
	"./backgroundsupermove4.png": 198,
	"./backgroundsupermove5.png": 199,
	"./backgroundsupermove6.png": 200,
	"./backgroundsupermove7.png": 201,
	"./backgroundsupermove8.png": 202,
	"./backgroundsvlevel.png": 203,
	"./basic.png": 204,
	"./construct.png": 205,
	"./crisis.png": 206,
	"./destination.png": 207,
	"./equipment.png": 208,
	"./equipmenttransformed.png": 209,
	"./hero.png": 210,
	"./herotransformed.png": 211,
	"./hostage.png": 212,
	"./location.png": 213,
	"./nemesislevel.png": 214,
	"./oversized-super-hero.png": 215,
	"./oversized-super-villain.png": 216,
	"./starter.png": 217,
	"./startertransformed.png": 218,
	"./super-hero.png": 219,
	"./super-move.png": 220,
	"./super-power.png": 221,
	"./super-villain.png": 222,
	"./supermove.png": 223,
	"./typeless.png": 224,
	"./villain.png": 225,
	"./villaintransformed.png": 226,
	"./vp-variable.png": 227,
	"./weakness.png": 228
};
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return new Promise(function (resolve, reject) {
                utils_1.loadTextures([_this.imageURL, _this.logoURL], function () {
                    _this.renderSync();
        ...
        value: function formatText() {
            ...
            formattedText = utils_1.surroundText(formattedText, /\+(.*?)\ Power/g, "[b]", "[/b]");
            formattedText = utils_1.surroundText(formattedText, /(\d)\ Power/g, "[b]", "[/b]");
            formattedText = utils_1.surroundText(formattedText, /\(([^)]+)\)/g, "[i]", "[/i]");
            formattedText = utils_1.surroundText(formattedText, /(Stack)\ Ongoing/g, "[b]", "[/b]");
            ...
            try {
                for (var _iterator = boldKeywords[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    formattedText = utils_1.replaceAll(formattedText, toBold, "[b]" + toBold + "[/b]");
                }
            } catch (err) {
                _didIteratorError = true;
                _iteratorError = err;
        ...
        value: function renderLogo() {
            ...
            var logoSprite = utils_1.newSprite(this.logoURL, this.container);
        ...
        value: function renderCost() {
            ...
            if (this.subtype == "CONDITIONAL COST") {
                ...
                var _cardCostBackStyle = this.getStyle("cost");
                var _cardCostBackText = new PIXI.Text(String(this.cost), _cardCostBackStyle);
                _cardCostBackText.pivot.x = _cardCostBackText.width / 2;
                _cardCostBackText.pivot.y = _cardCostBackText.height / 2;
                _cardCostBackText.position.set(641, 958);
                this.container.addChild(_cardCostBackText);
                var _cardCostFrontStyle = _cardCostBackStyle.clone();
                _cardCostFrontStyle.stroke = "#ffffff";
                _cardCostFrontStyle.strokeThickness = 10;
                var _cardCostFrontText = new PIXI.Text(String(this.cost), _cardCostFrontStyle);
                _cardCostFrontText.pivot.x = _cardCostFrontText.width / 2;
                _cardCostFrontText.pivot.y = _cardCostFrontText.height / 2;
                _cardCostFrontText.position.set(641, 958);
                this.container.addChild(_cardCostFrontText);
            }
        }
    }, {
        key: "renderSMCost",
        value: function renderSMCost() {
            ...
            utils_1.newSprite("backgroundsupermove" + this.cost, this.container);
            var cardCostBackStyle = this.getStyle("cost");
            var cardCostBackText = new PIXI.Text(String(this.cost), cardCostBackStyle);
            cardCostBackText.pivot.x = cardCostBackText.width / 2;
            cardCostBackText.pivot.y = cardCostBackText.height / 2;
        ...
        key: "renderDestination",
        value: function renderDestination() {
            if (this.oversized || this.type !== "Villain" || this.destination == 0) {
                return;
            }
            utils_1.newSprite("destination", this.container);
            var cardCostFrontStyle = this.getStyle("destination");
        ...
        value: function renderNL() {
            ...
            if (this.type == "Villain") {
                ...
                var _cardCostFrontText2 = new PIXI.Text(String("LEVEL " + this.nlu), _NLStyle);
                _cardCostFrontText2.pivot.x = _cardCostFrontText2.width / 2;
                _cardCostFrontText2.pivot.y = _cardCostFrontText2.height / 2;
                _cardCostFrontText2.skew.x = -0.180;
                _cardCostFrontText2.position.set(535, 718);
                this.container.addChild(_cardCostFrontText2);
            }
        }
    }, {
        key: "renderVP",
        ...
        value: function renderText() {
            ...
            formattedText = utils_1.replaceAll(formattedText, "[b]", utils_1.wrapStyledTextCharacters.boldStart);
            formattedText = utils_1.replaceAll(formattedText, "[/b]", utils_1.wrapStyledTextCharacters.boldEnd);
            formattedText = utils_1.replaceAll(formattedText, "[i]", utils_1.wrapStyledTextCharacters.italicStart);
            formattedText = utils_1.replaceAll(formattedText, "[/i]", utils_1.wrapStyledTextCharacters.italicEnd);
            ...
            var textContainer = utils_1.autoSizeAndWrapStyledText(formattedText, maxWidth - x * 2, maxHeight, style, 1, collisions, this.oversized, this.oversized);
    ...
    _createClass(DeckBuilder, [{
        ...
        value: function renderCards(normalCards, oversizedCards) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                utils_1.loadTextures(Array.from(textures), function () {
...
var entireReadme = __webpack_require__(270);
...
var DeckGeneratorTab = function (_tabular_1$Tab) {
    ...
    function DeckGeneratorTab() {
        ...
        _this.fakeLabelElement = utils_1.select(_this.element, ".file-name");
        _this.noneSelectedElement = utils_1.select(_this.fakeLabelElement, ".none-selected");
        _this.generateButton = utils_1.select(_this.element, ".generate-button");
        _this.maxCardsXInput = utils_1.select(_this.element, ".max-cards-x-input");
        _this.maxCardsYInput = utils_1.select(_this.element, ".max-cards-y-input");
        _this.progressBarElement = utils_1.select(_this.element, ".progress-bar-foreground");
        _this.generationLog = utils_1.select(_this.element, ".generation-log");
        _this.downloadButton = utils_1.select(_this.element, ".download-button");
        _this.inputElement = utils_1.select(_this.element, ".csv-file-selector");
        _this.generationDiv = utils_1.select(_this.element, ".generation");
    ...
    _createClass(DeckGeneratorTab, [{
        ...
        value: function updateFileInput() {
            ...
            this.fakeLabelElement.innerHTML = path_1.basename(utils_1.replaceAll(fakeValue, "\\", "/"));
            if (!fakeValue) {
        ...
        value: function generate() {
            ...
            if (file) {
                utils_1.expand(this.generationDiv).then(function () {
...
var tabular_1 = __webpack_require__(23);
var utils_1 = __webpack_require__(9);
var hbs = __webpack_require__(248);
...
var HelpTab = function (_tabular_1$Tab) {
...
function addTitlesTo(columns) {
    ...
    try {
        for (var _iterator = columns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            column.rowsTitle = utils_1.stripTagsFromString(card_options_1.CardOptions[name].description);
        }
    } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
...
var LiveEditorTab = function (_tabular_1$Tab) {
    ...
    function LiveEditorTab() {
        ...
        _this.scaleSlider = utils_1.select(_this.element, ".canvases-scale-slider");
        _this.scaleSlider.addEventListener("input", function () {
            return _this.resizeCanvases();
        });
        _this.scaleSliderPercent = utils_1.select(_this.element, ".canvases-scale-percent");
        _this.scaleSlider.value = store.get("card-scale") || 0.5;
        _this.defaultsTable = new table_1.EditableTable(utils_1.select(_this.element, ".defaults-table"));
        ...
        var cardsElement = utils_1.select(_this.element, ".cards-table");
        ...
        _this.resetToDefaultsButton = utils_1.select(_this.element, ".reset-to-defaults");
    ...
    _createClass(LiveEditorTab, [{
        ...
        value: function renderCard(row) {
            ...
            var defaults = utils_1.clone(this.defaultsTable.getRow(0).values);
            var args = utils_1.clone(defaults, row.values);
            card.setFrom(args);
...
var Tab = function Tab(name, element) {
    ...
    this.id = utils_1.toDashCase(this.name);
};
...
var Tabular = function (_events_1$EventEmitte) {
    ...
    function Tabular(tabs, parent) {
        ...
        _this.tabsList = utils_1.select(_this.element, "ul");
        _this.tabsContents = utils_1.select(_this.element, ".tabular-contents");
        if (tabs) {
            _this.setTabs(tabs);
        }
        if (parent) {
...
var UI = function UI(element) {
    ...
    this.mainElement = utils_1.select(this.element, "main");
    document.documentElement.setAttribute("data-browser", navigator.userAgent);
    document.title = this.title + " - " + this.subtitle;
    var faviconLink = document.createElement("link");
    faviconLink.href = __webpack_require__(233);
...
Object.defineProperty(exports, "__esModule", { value: true });
var FontFaceObserver = __webpack_require__(243);
...
// module
exports.push([module.i, "@font-face {\n  font-family: CompactaBT;\n  src: url(" + escape(__webpack_require__(238)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBT;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(236)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBT;\n  font-style: italic;\n  src: url(" + escape(__webpack_require__(237)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBdBT;\n  src: url(" + escape(__webpack_require__(235)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: CompactaBdBT;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(234)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  src: url(" + escape(__webpack_require__(241)) + ") format(\"woff\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(239)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  font-style: italic;\n  src: url(" + escape(__webpack_require__(240)) + ") format(\"opentype\"); }\n", ""]);
...
module.exports = __webpack_require__.p + "resources/5de2753b1848fb6afa8f2c1c50cdf247.png";
...
module.exports = __webpack_require__.p + "resources/6446750bbbbad3ea386ac1c4ef0cc478.png";

/***/ }),
/* 196 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/35fe06f3dc98a2d30d935ab5f512d70f.png";

/***/ }),
/* 197 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/a7a9ab2214a9aa96ac43326655fa9f0b.png";

/***/ }),
/* 198 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/35fae7827b542b4908615f33f30e07d6.png";

/***/ }),
/* 199 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/5468da4923feaec4fc813c0cd23d8d89.png";

/***/ }),
/* 200 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/c41ede449910c2501231c08aea67b683.png";

/***/ }),
/* 201 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/e247a5dbbbbcee4258c60ef6bb0b4ba2.png";

/***/ }),
/* 202 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "resources/5a2a45c1453284a460573761cf1fbe0d.png";
