...
var map = {
	...
	"./backgroundshlevel.png": 192,
	"./backgroundsvlevel.png": 193,
	"./basic.png": 194,
	"./crisis.png": 195,
	"./destination.png": 196,
	"./equipment.png": 197,
	"./equipmenttransformed.png": 198,
	"./hero.png": 199,
	"./herotransformed.png": 200,
	"./hostage.png": 201,
	"./location.png": 202,
	"./nemesislevel.png": 203,
	"./oversized-super-hero.png": 204,
	"./oversized-super-villain.png": 205,
	"./starter.png": 206,
	"./startertransformed.png": 207,
	"./super-hero.png": 208,
	"./super-power.png": 209,
	"./super-villain.png": 210,
	"./typeless.png": 211,
	"./villain .png": 212,
	"./villain.png": 213,
	"./vp-variable.png": 214,
...
var Card = function () {
    function Card(args) {
        ...
        this.name = "Card Name";
        this.type = "Starter" | "startertransformed" | "equipment-transformed" | "hero-transformed";
        this.variant = false;
        this.Bannerrows = 1;
        this.destination = 1;
    ...
    _createClass(Card, [{
        ...
        value: function renderType() {
            if (this.oversized || this.type === "Weakness" || this.type === "Hostage" || this.type === "Crisis" || this.type === "Basic" || this.type === "Typeless" || this.type === "startertransformed" || this.type === "equipmenttransformed" || this.type === "herotransformed") {
                return;
            }
...
var entireReadme = __webpack_require__(257);
...
var tabular_1 = __webpack_require__(23);
var utils_1 = __webpack_require__(9);
var hbs = __webpack_require__(235);
...
exports.cardsHeadings = [{
    ...
    name: "Type",
    allowedValues: ["Equipment", "Hero", "Hostage", "Location", "Starter", "Crisis", "Super Power", "Villain", "Typeless", "Basic", "Weakness", "startertransformed", "equipmenttransformed", "herotransformed"]
}, {
    name: "Text",
    longText: true
}, {
...
var UI = function UI(element) {
    ...
    faviconLink.href = __webpack_require__(220);
...
Object.defineProperty(exports, "__esModule", { value: true });
var FontFaceObserver = __webpack_require__(230);
...
// module
exports.push([module.i, "@font-face {\n  font-family: CompactaBT;\n  src: url(" + escape(__webpack_require__(225)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBT;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(223)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBT;\n  font-style: italic;\n  src: url(" + escape(__webpack_require__(224)) + ") format(\"opentype\"); }\n\n@font-face {\n  font-family: CompactaBdBT;\n  src: url(" + escape(__webpack_require__(222)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: CompactaBdBT;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(221)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  src: url(" + escape(__webpack_require__(228)) + ") format(\"woff\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  font-weight: bold;\n  src: url(" + escape(__webpack_require__(226)) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: TradeGothic;\n  font-style: italic;\n  src: url(" + escape(__webpack_require__(227)) + ") format(\"opentype\"); }\n", ""]);
